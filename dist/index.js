...
var init_html_widget = __esm({
  "src/app/obsidian-editor/extensions/markdown-syntax/html-decorator/html-widget.ts"() {
    init_types();
    DEBUG = false;
    HtmlPreviewWidget = class extends view.WidgetType {
...
function buildSmartDecorations(regions, view$1, inPreviewMode) {
  try {
    ...
    const docLength = view$1.state.doc.length;
...
var init_html_decorator = __esm({
  "src/app/obsidian-editor/extensions/markdown-syntax/html-decorator/index.ts"() {
    ...
    setHtmlDecorations = state.StateEffect.define();
    htmlDecorationsField = state.StateField.define({
        ...
        if (this.editorView) {
          ...
          try {
            this.editorView.dispatch({
              effects: state.StateEffect.appendConfig.of(extension)
            });
  ...
  "src/app/obsidian-editor/extensions/plugin-api/ExamplePlugin.ts"() {
    ...
    ExamplePlugin = class extends Plugin {
      ...
      async onEnable() {
        ...
        this.registerExtension(
          "heading-decorator",
          createSyntaxDecorator(["ATXHeading1", "ATXHeading2"], (node, view$1) => {
  ...
  "src/app/obsidian-editor/extensions/plugin-api/examples/WordCountPlugin.ts"() {
    ...
    WordCountPlugin = class extends Plugin {
      ...
      async onEnable() {
        ...
        const statusBarExtension = view.EditorView.updateListener.of((update) => {
...
${stats.lines} lines`;
      ...
      createLongParagraphHighlighter() {
        return view.EditorView.decorations.compute(["doc"], (state$1) => {
          const builder = new state.RangeSetBuilder();
          const doc = state$1.doc;
          let paraStart = 0;
          let currentPara = "";
...
var EditorCore = ({
  ...
  react.useEffect(() => {
    ...
    try {
      ...
      if (typeof window !== "undefined") {
        window.__obsidianEditorView = view$1;
      }
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { ref: editorRef, className: "obsidian-editor-core", style: { height: "100%" } });
};
...
var EditorToolbar = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "obsidian-editor-toolbar", children: [
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "toolbar-left", children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: "format-divider" }),
      /* @__PURE__ */ jsxRuntime.jsx(
        "button",
        {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsx("span", { className: "heading-btn", children: "H1" })
        }
      ),
      /* @__PURE__ */ jsxRuntime.jsx(
        "button",
        {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsx("span", { className: "heading-btn", children: "H2" })
        }
      ),
      /* @__PURE__ */ jsxRuntime.jsx(
        "button",
        {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsx("span", { className: "heading-btn", children: "H3" })
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "toolbar-right", children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(ThemeSwitcher_default, { onThemeChange })
    ] }),
    /* @__PURE__ */ jsxRuntime.jsx("style", { children: `
...
function Editor({ className, onEditorViewReady, ...props }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: `obsidian-editor-wrapper ${theme} ${className || ""}`, children: /* @__PURE__ */ jsxRuntime.jsx(
...
function ThemeToggle() {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    "button",
    {
      ...
      children: theme === "dark" ? /* @__PURE__ */ jsxRuntime.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [
      ...
      ] }) : /* @__PURE__ */ jsxRuntime.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ jsxRuntime.jsx("path", { d: "M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z" }) })
    }
  );
}
